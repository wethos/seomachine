...
SEO Machine is an open-source Codex workspace for creating SEO-optimized blog content. It combines custom commands, specialized agents, and Python-based analytics to research, write, optimize, and publish articles for any business.
...
All commands are defined in `.Codex/commands/` and invoked as slash commands:
...
**Commands** (`.Codex/commands/`) orchestrate workflows. **Agents** (`.Codex/agents/`) are specialized roles invoked by commands. After `/write`, these agents auto-run: SEO Optimizer, Meta Creator, Internal Linker, Keyword Mapper.
